...
describe('<SaveButton />', () => {
    it('should render <RaisedButton /> when raised is true', () => {
        const wrapper = shallow(
            <SaveButton raised translate={translate} />,
        );
    ...
    it('should render as submit type when submitOnEnter is true', () => {
        const raisedButtonWrapper = shallow(
            <SaveButton raised submitOnEnter translate={translate} />,
        );
        const flatButtonWrapper = shallow(
            <SaveButton raised={false} submitOnEnter translate={translate} />,
        );
    ...
    it('should render as button type when submitOnEnter is false', () => {
        const raisedButtonWrapper = shallow(
            <SaveButton raised submitOnEnter={false} translate={translate} />,
        );
        const flatButtonWrapper = shallow(
    ...
    it('should trigger submit action when clicked if no saving is in progress', () => {
        ...
        const raisedButtonWrapper = shallow(
            <SaveButton raised translate={translate} handleSubmitWithRedirect={() => onSubmit} saving={false} />,
        );
        const flatButtonWrapper = shallow(
    ...
    it('should not trigger submit action when clicked if saving is in progress', () => {
        ...
        const raisedButtonWrapper = shallow(
            <SaveButton raised translate={translate} handleSubmitWithRedirect={() => onSubmit} saving />,
        );
        const flatButtonWrapper = shallow(
            <SaveButton raised={false} translate={translate} handleSubmitWithRedirect={() => onSubmit} saving />,
        );
