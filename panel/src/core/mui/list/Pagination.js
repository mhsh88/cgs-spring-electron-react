        ...
        return width === 1 ? (
            <Toolbar>
                <ToolbarGroup style={styles.mobileToolbar}>
                    ...
                    <span style={styles.pageInfo}>{translate('hcore.navigation.page_range_info', { offsetBegin, offsetEnd, total })}</span>
                    {page !== nbPages &&
            ...
            <Toolbar>
                <ToolbarGroup firstChild>
                    <span className="displayed-records" style={styles.pageInfo}>{translate('hcore.navigation.page_range_info', { offsetBegin, offsetEnd, total })}</span>
                </ToolbarGroup>
                {nbPages > 1 &&
                    <ToolbarGroup>
                        {page > 1 &&
