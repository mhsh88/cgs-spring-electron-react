...
export class List extends Component {
    ...
    render() {
        const { filters, pagination = <DefaultPagination />, actions = <DefaultActions />, resource, hasCreate, title, data, ids, total, children, isLoading, translate, theme, width } = this.props;
        ...
        const defaultTitle = translate('hcore.page.list', { name: `${resourceName}` });
            ...
            <div className="list-page">
                <Card style={{ opacity: isLoading ? 0.8 : 1 }}>
                    ...
                    { isLoading || total > 0 ?
                        ...
                        :
                        <CardText style={styles.noResults}>{translate('hcore.navigation.no_results')}</CardText>
                    }
                </Card>
            </div>
        );
