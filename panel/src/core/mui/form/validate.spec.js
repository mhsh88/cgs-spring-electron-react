...
describe('Validators', () => {
    const test = (validator, inputs, message) =>
        assert.deepEqual(
            inputs
                ...
                .filter(m => m === message)
            ,
            Array(...Array(inputs.length)).map(x => message),
        );
    ...
    describe('required', () => {
        ...
        it('should return an error message if the value is empty', () => {
            test(required, [undefined, '', null], 'hcore.validation.required');
        });
    });
    describe('minLength', () => {
        ...
        it('should return an error message if the value has smaller length than the given minimum', () => {
            test(minLength(5), ['1234', '12'], 'hcore.validation.minLength');
        });
    });
    describe('maxLength', () => {
        it('should return undefined if the value is empty', () => {
        ...
        it('should return an error message if the value has higher length than the given maximum', () => {
            test(maxLength(10), ['12345678901'], 'hcore.validation.maxLength');
        });
    });
    describe('minValue', () => {
        it('should return undefined if the value is empty', () => {
        ...
        it('should return an error message if the value is lower than the given minimum', () => {
            test(minValue(10), [1, 9.5, '5'], 'hcore.validation.minValue');
        });
    });
    describe('maxValue', () => {
        it('should return undefined if the value is empty', () => {
        ...
        it('should return an error message if the value is higher than the given maximum', () => {
            test(maxValue(10), [11, 10.5, '11'], 'hcore.validation.maxValue');
        });
    });
    describe('number', () => {
        it('should return undefined if the value is empty', () => {
        ...
        it('should return an error message if the value is not a number', () => {
            test(number, ['foo'], 'hcore.validation.number');
        });
    });
    describe('regex', () => {
        it('should return undefined if the value is empty', () => {
    ...
    describe('email', () => {
        ...
        it('should return an error if the value is not a valid email', () => {
            test(email, ['foo@bar', 'hello, world'], 'hcore.validation.email');
        });
    });
    describe('choices', () => {
        it('should return undefined if the value is empty', () => {
