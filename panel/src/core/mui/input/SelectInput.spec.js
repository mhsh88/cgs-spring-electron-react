...
describe('<SelectInput />', () => {
    ...
    it('should use a mui SelectField', () => {
        const wrapper = shallow(<SelectInputComponent {...defaultProps} input={{ value: 'hello' }} />);
    ...
    it('should use the input parameter value as the initial input value', () => {
        const wrapper = shallow(<SelectInputComponent {...defaultProps} input={{ value: 2 }} />);
    ...
    it('should render choices as mui MenuItem components', () => {
        const wrapper = shallow(<SelectInputComponent
            {...defaultProps}
            choices={[
                { id: 'M', name: 'Male' },
                { id: 'F', name: 'Female' },
    ...
    describe('error message', () => {
        it('should not be displayed if field is pristine', () => {
            const wrapper = shallow(<SelectInputComponent {...defaultProps} meta={{ touched: false }} />);
            const SelectFieldElement = wrapper.find('SelectField');
            assert.equal(SelectFieldElement.prop('errorText'), false);
        });

        it('should not be displayed if field has been touched but is valid', () => {
            const wrapper = shallow(<SelectInputComponent {...defaultProps} meta={{ touched: true, error: false }} />);
            const SelectFieldElement = wrapper.find('SelectField');
            assert.equal(SelectFieldElement.prop('errorText'), false);
        });

        it('should be displayed if field has been touched and is invalid', () => {
            const wrapper = shallow(<SelectInputComponent {...defaultProps} meta={{ touched: true, error: 'Required field.' }} />);
            const SelectFieldElement = wrapper.find('SelectField');
