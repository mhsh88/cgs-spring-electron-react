...
export class SelectInputComponent extends Component {
    ...
    renderMenuItem = (choice) => {
        ...
        let choiceName = React.isValidElement(optionText) ?
        ...
        if (choiceName && typeof choiceName === 'object') {
            ...
            if (hasResourceAnyLocale) {
                choiceName = get(choiceName, language);
                if (choiceName === undefined || choiceName === null) {
                    choiceName = get(choiceName, DEFAULT_LANGUAGE);
                }
                if (choiceName === undefined || choiceName === null) {
                    choiceName = get(choiceName, get(choiceName, INITIAL_LANGUAGE));
                }
            }
        }
        return (
...
const SelectInput = enhance(SelectInputComponent);
